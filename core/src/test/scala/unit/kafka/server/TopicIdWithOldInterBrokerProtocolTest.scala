...
import org.apache.kafka.server.config.{ServerConfig, ReplicationConfigs}
...
class TopicIdWithOldInterBrokerProtocolTest extends BaseRequestTest {
  ...
  override def brokerPropertyOverrides(properties: Properties): Unit = {
    ...
    properties.setProperty(ServerConfig.BROKER_RACK_CONFIG, s"rack/${properties.getProperty(ServerConfig.BROKER_ID_CONFIG)}")
  }
