...
public class TieredStorageTestUtils {
    ...
    public static Properties createPropsForRemoteStorage(String testClassName,
        ...
        overridingProps.put(ServerConfig.UNSTABLE_API_VERSIONS_ENABLE_CONFIG, "true");
        overridingProps.put(ServerConfig.UNSTABLE_FEATURE_VERSIONS_ENABLE_CONFIG, "true");
