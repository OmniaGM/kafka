...
public class KafkaEmbedded {
    ...
    private Properties effectiveConfigFrom(final Properties initialConfig) {
        ...
        effectiveConfig.put(ServerConfig.BROKER_ID_CONFIG, 0);
        effectiveConfig.put(NUM_PARTITIONS_CONFIG, 1);
        effectiveConfig.put(AUTO_CREATE_TOPICS_ENABLE_CONFIG, true);
        effectiveConfig.put(ServerConfig.MESSAGE_MAX_BYTES_CONFIG, 1000000);
        effectiveConfig.put(ServerConfig.CONTROLLED_SHUTDOWN_ENABLE_CONFIG, true);
