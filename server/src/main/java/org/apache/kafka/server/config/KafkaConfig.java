...
public class KafkaConfig {
    ...
    public final static ConfigDef CONFIG_DEF =  new ConfigDef()
        ...
        .define(KafkaServerConfigs.COMPRESSION_TYPE_CONFIG, STRING, LogConfig.DEFAULT_COMPRESSION_TYPE, ConfigDef.ValidString.in(BrokerCompressionType.names().toArray(new String[0])), HIGH, KafkaServerConfigs.COMPRESSION_TYPE_DOC)
